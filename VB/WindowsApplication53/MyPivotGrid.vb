...
Namespace WindowsApplication53
	...
	Public Class MyPivotGridPrinter
		...
		Protected Overrides Function DrawHeaderBrick(ByVal field As PivotFieldItemBase, ByVal bounds As Rectangle) As ITextBrick
			...
			If Owner IsNot Nothing Then
				If Owner.CustomExportHeader(brick, field, appearance) Then
		...
		Private Sub ApplyAppearanceToBrickStyleCore(ByVal brick As IVisualBrick, ByVal appearance As IPivotPrintAppearance)
			Dim brickStyle As BrickStyle
			If brick.Style IsNot Nothing Then
				brickStyle = CType(brick.Style.Clone(), BrickStyle)
			Else
				brickStyle = CType(Graph.DefaultBrickStyle.Clone(), BrickStyle)
			End If
