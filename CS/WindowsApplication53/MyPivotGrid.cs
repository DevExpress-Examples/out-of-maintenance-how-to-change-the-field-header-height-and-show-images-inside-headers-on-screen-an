...
namespace WindowsApplication53
{
    ...
    {
        int imageHeight;
        public MyFieldMeasuresPrinting(PivotGridViewInfoData data, PivotGridAppearancesBase appearances)
            : base(data, appearances) {
                imageHeight = ((ImageList)data.HeaderImages).ImageSize.Height;
        }
        protected override int CalculateDefaultHeaderHeight()
        {
            int baseHeight = base.CalculateDefaultHeaderHeight();
